...
function Dashboard() {
    return (
        <div>
             <section id="main-body" className="mt-11 w-full dark:bg-slate-500">
                <div className="p-2">
                                ...
                                <a href="" className="leading-10">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-lg leading-10">Profit</p>
                                        </div>
                                        <div>
                                            <i>
                                   ...
                                   <div className="border-t-2 border-white"></div>
                                    <div className="flex justify-between items-center">
                                        <p className="text-sm leading-10">Last Update: 27 Nov 22 17:30</p>
                                        <i>
